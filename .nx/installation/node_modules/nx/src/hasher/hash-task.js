...
function hashTasksThatDoNotDependOnOutputsOfOtherTasks(hasher, projectGraph, taskGraph, nxJson) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const tasks = Object.values(taskGraph.tasks);
        const tasksWithHashers = yield Promise.all(tasks.map((task) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const customHasher = yield (0, utils_1.getCustomHasher)(task, projectGraph);
...
function hashTask(hasher, projectGraph, taskGraph, task) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const customHasher = yield (0, utils_1.getCustomHasher)(task, projectGraph);
