...
class ForkedProcessTaskRunner {
    ...
    getDotenvVariablesForTask(task) {
        if (process.env.NX_LOAD_DOT_ENV_FILES == 'true') {
            return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, this.getDotenvVariablesForForkedProcess()), parseEnv(`.${task.target.target}.env`)), parseEnv(`.env.${task.target.target}`)), (task.target.configuration
                ? Object.assign(Object.assign(Object.assign(Object.assign({}, parseEnv(`.${task.target.configuration}.env`)), parseEnv(`.${task.target.target}.${task.target.configuration}.env`)), parseEnv(`.env.${task.target.configuration}`)), parseEnv(`.env.${task.target.target}.${task.target.configuration}`)) : {})), parseEnv(`${task.projectRoot}/.env`)), parseEnv(`${task.projectRoot}/.local.env`)), parseEnv(`${task.projectRoot}/.env.local`)), parseEnv(`${task.projectRoot}/.${task.target.target}.env`)), parseEnv(`${task.projectRoot}/.env.${task.target.target}`)), (task.target.configuration
                ? Object.assign(Object.assign(Object.assign(Object.assign({}, parseEnv(`${task.projectRoot}/.${task.target.configuration}.env`)), parseEnv(`${task.projectRoot}/.${task.target.target}.${task.target.configuration}.env`)), parseEnv(`${task.projectRoot}/.env.${task.target.configuration}`)), parseEnv(`${task.projectRoot}/.env.${task.target.target}.${task.target.configuration}`)) : {}));
        }
        else {
            return {};
        }
